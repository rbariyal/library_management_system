...
JPanel panel=new JPanel();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==b1)
        {
            ...
            s.setString(5,(String) comboBox.getSelectedItem());
