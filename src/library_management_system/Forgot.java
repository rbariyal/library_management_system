...
public class Forgot extends JFrame implements ActionListener {
    ...
    public Forgot() {
        ...
        contentPane.setLayout(null); // DEfault layout is border layout
        ...
        t4.setForeground(new Color(105, 105, 105));
        ...
        t5.setForeground(new Color(105, 105, 105));
