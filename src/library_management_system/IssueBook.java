...
public class IssueBook extends JFrame implements ActionListener {
    ...
    public IssueBook() {
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 3), "Issue-Book", TitledBorder.LEADING,
        ...
        panel1.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 3), "Student-Details", TitledBorder.LEADING,
                TitledBorder.TOP, null, new Color(34, 139, 34)));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            if (e.getSource() == b2) {
                ...
                if (e.getSource() == b3) {
                    try{
               String sql="insert into issuebook(book_id,student_id,bname,sname,course,branch,datOfissue) values(?,?,?,?,?,?,?)";
               PreparedStatement st=con.c.prepareStatement(sql);
               st.setString(1,t1.getText());
